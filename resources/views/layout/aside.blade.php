                ...
                <ul class="menu">
                    ...
                    <li class="sidebar-item {{ request()->segment(1) == 'master' ? 'active' : '' }} has-sub">
                        ...
                        <ul class="submenu {{ request()->segment(1) == 'master' ? 'active' : '' }}">
                            <li class="submenu-item {{ request()->segment(2) == 'category' ? 'active' : '' }}">
                                <a href="{{ url('/master/category') }}"> Kategori </a>
                            </li>
                            <li class="submenu-item {{ request()->segment(2) == 'merchandise' ? 'active' : '' }}">
                                <a href="{{ url('/master/merchandise') }}"> Menu </a>
                            </li>
                            <li class="submenu-item {{ request()->segment(2) == 'promo' ? 'active' : '' }}">
                                <a href="{{ url('/master/promo') }}"> Promo Diskon </a>
                            </li>
                            <li class="submenu-item {{ request()->segment(2) == 'edc' ? 'active' : '' }}">
                                <a href="{{ url('/master/edc') }}"> Mesin Edc </a>
                            </li>
                            <li class="submenu-item {{ request()->segment(2) == 'users' ? 'active' : '' }}">
                                <a href="{{ url('/master/users') }}"> Pengguna </a>
                            </li>
                        </ul>
                    </li>
                    {{-- <li class="sidebar-item {{ request()->segment(1) == 'master' ? 'active' : '' }} has-sub">
                        ...
                        <ul class="submenu {{ request()->segment(1) == 'promo' ? 'active' : '' }}">
                            <li class="submenu-item {{ request()->segment(2) == 'diskon' ? 'active' : '' }}">
                                <a href="{{ url('/promo/diskon') }}"> Diskon </a>
                            </li>
                            <li class="submenu-item {{ request()->segment(2) == 'merchandise' ? 'active' : '' }}">
                    ...
                    <li class="sidebar-item {{ request()->segment(2) == 'apps' ? 'active' : '' }}">
                        <a href="{{ url('/setting/apps') }}" class='sidebar-link'>
                            <i class="bi bi-building"></i>
                            <span> Setting Aplikasi </span>
                        </a>
                    </li>

                    <li class="sidebar-item {{ request()->segment(2) == 'struck' ? 'active' : '' }}">
                        <a href="{{ url('/setting/struck') }}" class='sidebar-link'>
                            <i class="bi bi-receipt"></i>
                            <span> Setting Struck </span>
                        </a>
                    </li>

                    <li class="sidebar-item {{ request()->segment(2) == 'profile' ? 'active' : '' }}">
                        <a href="{{ url('/setting/profile') }}" class='sidebar-link'>
                    ...
                    <li class="sidebar-item ">
                        <a href="{{ url('/sign_out') }}" class='sidebar-link'
